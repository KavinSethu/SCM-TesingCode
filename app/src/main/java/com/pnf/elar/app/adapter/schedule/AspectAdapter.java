...
public class AspectAdapter extends RecyclerView.Adapter<AspectAdapter.AspectHolder> {

Context context;
    List<AspectResponseBo.AspectsEntity> aspectList=new ArrayList<>();

   public AspectAdapter(Context context, List<AspectResponseBo.AspectsEntity> aspectList)
    {
        super();
    ...
    public void onBindViewHolder(AspectHolder holder, final int position) {
        ...
        holder.nameText.setText(aspectList.get(position).getAspect().getName());
        holder.idText.setText(aspectList.get(position).getAspect().getId());
        holder.checkBox.setChecked(aspectList.get(position).getAspect().isSelected());
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
               ...
               /* if(b)
                {*/
                    ...
                    aspectList.get(position).getAspect().setSelected(b);
/*
                }
*/
            }
  ...
  /*  View row = inflater.inflate(R.layout.item_course_spinner, parent, false);
    ...
    try
    {
        ...
        *//***** Get each Model object from Arraylist ********//*
        ...
        AspectResponseBo.AspectsEntity   aspectsEntity = aspectList.get(position);
