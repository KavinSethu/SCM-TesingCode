...
public class WeekViewEvent {
    ...
    public WeekViewEvent(long id, String name, String location, Calendar startTime, Calendar endTime, String mEventDate, boolean allDay) {
        this.mId = id;
        this.mName = name;
        this.mLocation = location;
        this.mStartTime = startTime;
     ...
     * @param endTime The time when the event ends.
     */
    public WeekViewEvent(long id, String name, String location, Calendar startTime, Calendar endTime, String mEventDate) {
        this(id, name, location, startTime, endTime,mEventDate, false);
    }
    ...
    public WeekViewEvent(long id, String name, Calendar startTime, Calendar endTime, String mEventDate) {
        this(id, name, null, startTime, endTime,mEventDate);
    }
