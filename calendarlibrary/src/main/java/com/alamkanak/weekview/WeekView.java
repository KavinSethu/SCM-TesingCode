...
/*
        System.out.println("fri"+getFirstVisibleDate()+" scroll"+mScrollToDay+" wqw"+today);
*/

     /*  if (mScrollToDay != null) {
           mScrollToDay=getFirstVisibleDay();
            today = getFirstVisibleDate();
        } else {
            today = today();
        }
*/
        ...
        System.out.println("mHeaderColumnWidth"+mHeaderColumnWidth);
        ...
        for (int dayNumber = leftDaysWithGaps + 1; dayNumber <= leftDaysWithGaps + mNumberOfVisibleDays + 1; dayNumber++) {
            ...
            System.out.println("dayLabel :: "+dayLabel);
...
/*
                        System.out.println("DateTimeInterpreter"+sdf.format(date.getTime().getDay()+"\n"+date.getTime().getDate()+"\n"+date.getTime().getMonth()));
*/
...

    {
        ...
        System.out.println("mFirstVisibleDay" + mFirstVisibleDay);
        return mFirstVisibleDay;
